...
export default function VisitingClients() {
  return (
    <div className="flex flex-col items-center justify-center min-h-[60vh] text-center space-y-10">
      ...
      <div className="space-y-4">
        <h1 className="text-5xl md:text-7xl font-extrabold tracking-tight">
          Manage Your <span className="text-primary">Visiting Clients</span> <br />
          With Confidence.
        </h1>
        <p className="text-gray-400 text-lg md:text-xl max-w-2xl mx-auto">
          Track client visits, locations, follow-ups, remarks and compliment status efficiently.
          Streamline your client relationship management with ease.
        </p>
      </div>

      <div className="flex flex-col sm:flex-row gap-6 w-full max-w-lg">
        <Link
          href="/visiting-clients/add"
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8 w-full max-w-5xl pt-10 border-t border-dark-border/50">
        <div className="p-6 bg-dark-surface/50 rounded-2xl border border-dark-border text-left space-y-3">
          ...
          <p className="text-gray-500 text-sm">Quick forms for logging client visits and details.</p>
        </div>
        ...
        <div className="p-6 bg-dark-surface/50 rounded-2xl border border-dark-border text-left space-y-3">
          ...
          <p className="text-gray-500 text-sm">Instant filtering by name, contact, location or remarks.</p>
        </div>
        ...
        <div className="p-6 bg-dark-surface/50 rounded-2xl border border-dark-border text-left space-y-3">
          ...
          <p className="text-gray-500 text-sm">Download client records as Excel with one click.</p>
        </div>
      </div>
    </div>
  );
