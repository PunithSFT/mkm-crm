...
import { getAllDailyVisitingCustomers } from '@/lib/db';

export async function GET() {
  try {
    const rawData = await getAllDailyVisitingCustomers();
    ...
    XLSX.utils.book_append_sheet(wb, ws, 'Daily Visiting');
    ...
    return new NextResponse(buffer, {
      ...
      headers: {
        ...
        'Content-Disposition': 'attachment; filename="daily-visiting-customers.xlsx"',
      },
    });
  } catch (e) {
